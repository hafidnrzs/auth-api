...
/**
 * AddUserUseCase function is to manage the flow when doing add user
 * action. The use case orchestrate the repository and service that
 * being used in order the action can be successfully done.
 */
